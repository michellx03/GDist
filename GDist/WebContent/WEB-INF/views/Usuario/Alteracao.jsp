...
<%@page
	import="br.com.gdist.daoGenericos.UsuarioDaoImplementacao"%>
<%@page import="br.com.gdist.daoGenericos.UsuarioDao"%>
<%@page import="br.com.gdist.entity.Usuario"%>
...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/GDist/Usuario/Consulta">Consulta</a>
				<i class="fa fa-circle"></i></li>
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/GDist/Usuario/Salvar"
...
<t:master>
	...
	<jsp:attribute name="scripts_js_page_level_plugins">
        ...
        <script
			src="/GDist/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"
...
<script
			src="/GDist/assets/pages/scripts/form-validation.min.js"
			type="text/javascript"></script>
